...
- [topics/gradostroitelstvo/rekonstrukciya-pristoyka.md](topics/gradostroitelstvo/rekonstrukciya-pristoyka.md) — **Пристройка vs Отдельное здание**: Сравнительная таблица критериев квалификации объекта — правовые признаки, конструктивные критерии, инженерные системы, землепользование, экспертные требования, правовые риски (ст. 222 ГК РФ), кадастровый учёт, процедуры согласования. | `verified` | теги: `ГрК` `реконструкция` `самовольное-строительство` `разрешение-на-строительство` `кадастр` `ЕГРН` `ГК`

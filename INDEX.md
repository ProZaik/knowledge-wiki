...
- [topics/gradostroitelstvo/razreshenie-na-stroitelstvo-isklyucheniya.md](topics/gradostroitelstvo/razreshenie-na-stroitelstvo-isklyucheniya.md) — **Разрешение на строительство — исключения**: Перечень объектов и случаев, при которых разрешение на строительство не требуется (ч. 17 ст. 51 ГрК РФ), уведомительный порядок для ИЖС, практика квалификации объектов как не требующих разрешения. | `draft` | теги: `разрешение-на-строительство` `ГрК` `ИЖС` `некапитальные-строения`
...
- Всего файлов в базе: **36** (20 sources + 12 topics + 4 _index.md)

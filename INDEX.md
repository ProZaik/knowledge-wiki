...
- [inbox/zouity-ustanovlenie-do-rns.md](inbox/zouity-ustanovlenie-do-rns.md) — **ЗОУИТ: установление до РнС**: Право (не обязанность) застройщика инициировать ЗОУИТ до выдачи РнС; отсутствие решения о ЗОУИТ — не основание для отказа; срок установления ЗОУИТ после ввода — 12 мес. Единственный источник по теме — ждёт второго для переноса в topics/. | `draft` | теги: `ЗОУИТ` `разрешение-на-строительство` `застройщик` `Минстрой` `ГрК` `ЗК`
...
- Всего файлов в базе: **43** (23 sources + 12 topics + 1 inbox + 4 _index.md)
- Тем: **4 домена**, **12 тематических файлов**
- Черновиков в inbox: **1**
